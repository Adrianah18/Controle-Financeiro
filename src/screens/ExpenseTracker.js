...
import { TouchableOpacity,View, Text, Button, Vibration, StyleSheet, TextInput, ScrollView } from 'react-native';
...
const ExpenseTracker = () => {
  ...
  <View key={index} style={styles.expenseItem}>
    <Text style={styles.expenseText}>
      <Text style={styles.expenseDetail}>Nome:</Text> {item.name}{'\n'}
      <Text style={styles.expenseDetail}>Valor: R$ </Text>
            <Text style={[styles.expenseValue, styles.expenseDetail]}>{item.amount}</Text>
            {'\n'}
      <Text style={styles.expenseDetail}>Vencimento:</Text> {item.dueDate}{'\n'}
      <Text style={styles.expenseDetail}>Categoria:</Text> {item.category}{'\n'}
      <Text style={styles.expenseDetail}>Frequência:</Text> {item.frequency}
    </Text>
    ...
    {index < expenses.length - 1 && <View style={styles.expenseSeparator} />}
  </View>
))}
</ScrollView>
);
